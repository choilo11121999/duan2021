...
function BookingStatRoomFour ({ idBooking, dateBooking, timeBooking, user, getUrlPay }) {
  ...
  useEffect(() => {
    axios.get(`api/select-list/show?product_id=${idBooking}&show_date=${dateBooking}&show_time=${timeBooking}&room_id=4`).then((res) => {
...
export default BookingStatRoomFour; 
